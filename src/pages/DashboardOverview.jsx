...
import useInventoryStore from '../stores/inventoryStore'; // Import Zustand store
...
const DashboardOverview = () => {
  // ดึงข้อมูลและฟังก์ชันจาก Zustand store โดยตรง
  const { products, getInventoryStats } = useInventoryStore(state => ({
